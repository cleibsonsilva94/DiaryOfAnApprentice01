...
O Git é de longe a melhor ferramenta de versionamento que existe. No começo, sugiro que você anote os principais comandos. 
Mas quais, diante de tantos que existem? Os que você perceber que são mais atualizados na sua empresa ou os que permitirão 
que você consiga editar códigos, salvá-los temporariamente e submetê-los a um avaliador.

Anote esses comandos em um lugar onde você consiga acessá-los facilmente (eu anotava no Slack) e com o tempo você vai decorar boa parte deles
e digo mais, desenvolverá um grande amor e fascínio pelo recurso mais que perfeito: Git :)
